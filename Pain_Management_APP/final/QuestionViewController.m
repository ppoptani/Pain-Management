...
- (IBAction)nextQuestion {
    ...
    if (questionNumber >= [questions count]) {
        ...
        [quest.instructionList enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            instruction1.text = [NSString stringWithFormat:@"%d. %@",idx,[obj instructionDetail]];
                ins1 = YES;
            }else if(ins2 == NO){
                instruction2.hidden = NO;
                instruction2.text = [NSString stringWithFormat:@"%d. %@",idx,[obj instructionDetail]];
                ins2 = YES;
            }else if(ins3 == NO){
                instruction3.hidden = NO;
                instruction3.text = [NSString stringWithFormat:@"%d. %@",idx,[obj instructionDetail]];
                ins3 = YES;
            }else if(ins4 == NO){
                instruction4.hidden = NO;
                instruction4.text = [NSString stringWithFormat:@"%d. %@",idx,[obj instructionDetail]];
                ins4 = YES;
            }else if(ins5 == NO){
                instruction5.hidden = NO;
                instruction5.text = [NSString stringWithFormat:@"%d. %@",idx,[obj instructionDetail]];
                ins5 = YES;
            }
        }];
        ...
        [[self instructions] setTitle:@"< Previous Question" forState:UIControlStateNormal];
    }
}
...
- (void)viewDidLoad {
    ...
    instructionText.text = @"The instruction for questionaiare ";
